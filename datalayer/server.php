...
if (isset($_POST['Register']))
{
    ...
    if (count($errors) == 0)
    {
        ...
        header('location:../applicationlayer/patient_login.php');
    }
}
...
if (isset($_POST['Login']))
{
    ...
    if (count($errors) == 0)
    {
        ...
        if (mysqli_num_rows($result) == 1)
        {
            $_SESSION['UserID'] = $UserID;
            $_SESSION['success'] = "you are now logged in";
            header('location:../presentationlayer/patient/patientinfo.php');
        }
        else
        {
...
if (isset($_POST['Login2']))
{
    ...
    if (count($errors) == 0)
    {
        ...
        if (mysqli_num_rows($resultD) == 1)
        {
            ...
            $_SESSION['success'] = "you are now logged in";
            header('location:../presentationlayer/doctor/viewdoctor.php');
        }
        else
        {
            array_push($errors, "The ID/Password not correct");
...
if (isset($_POST['Login3']))
{
    ...
    if (count($errors) == 0)
    {
        ...
        if (mysqli_num_rows($resultA) == 1)
        {
            ...
            $_SESSION['success'] = "you are now logged in";
            header('location:../presentationlayer/admin/adddoctor.php');
        }
        else
        {
            array_push($errors, "The ID/Password not correct");
